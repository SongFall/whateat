...
import { createArticle } from "../../services/articles/articlesApi";
import { uploadToAliyun } from "../../services/upload/upload";
...
const AddArticlePage = () => {
  const [formData, setFormData] = useState({
    ...
    category: "烹饪技巧",
    tags: "",
    userId: parseInt(localStorage.getItem("userId")) || 1, // 确保userId是数字类型
  });
        ...
        {success && (
          <div className="mb-8 p-6 bg-green-50 border border-green-200 rounded-xl shadow-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold text-green-800 text-lg">文章发布成功！</h3>
                <p className="text-green-600">你的文章已经成功发布到平台</p>
              </div>
            </div>
          </div>
        )}
        ...
        {error && (
          <div className="mb-8 p-6 bg-red-50 border border-red-200 rounded-xl shadow-sm">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold text-red-800 text-lg">发布失败</h3>
